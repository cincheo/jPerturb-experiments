...
public class Window extends JFrame {
	...
	private class ModelObserver implements Observer {
		...
		public void update(Observable o, Object arg) {
			Tuple config = model.getConfig();
			labelAntifragile.setText("(" + config.get(0) + ")");
			labelRobust.setText("(" + config.get(1) + ")");
			labelWeak.setText("(" + config.get(2) + ")");
		}
	}
	...
	public Window(Model m) {
		...
		g2D.clearRect(this.panelImg.getX(), this.panelImg.getY(), this.panelImg.getX() + this.panelImg.getWidth(),
				this.panelImg.getY() + this.panelImg.getHeight());
